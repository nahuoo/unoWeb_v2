...
export const Equipos = (props) => {
  const { isFetching, setFiltro, setIndiceTabs, setEquipoNombre } = useContext(
    ContextProductos
  )
  ...
  return (
    <Card className={classes.root} key={props.id}>
      <CardActionArea onClick={handleClick}>
        <CardHeader title={props.nombre} subheader='Equipamiento' />
        <CardMedia
      ...
      <Collapse in={expanded} timeout='auto' unmountOnExit>
        <CardContent>
          <Typography paragraph>{props.descripcion}</Typography>
        </CardContent>
      </Collapse>
    </Card>
  )
